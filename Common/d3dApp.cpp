...
namespace Common
{
    ...
    std::shared_ptr<Window> D3DApp::CreateRenderWindow(std::shared_ptr<GDevice> device, const std::wstring& windowName,
                                                       int clientWidth,
    ...
    void D3DApp::DestroyWindow(const std::shared_ptr<Window>& window)
    {
